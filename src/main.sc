...
theme: /
    ...
    state: Start || sessionResult = "Сценарий начинается отсюда", sessionResultColor = "#143AD1"
        ...
        a: Добрый день! Я виртуальный секретарь О!РЕСУРС. Чем могу быть полезен?. || htmlEnabled = true, html = "Добрый день! Я виртуальный секретарь <b>Компании</b>. Могу уточнить статус вашего заказа или рассказать о времени работы офиса."
        buttons:
            "Наставник" -> /Форма для наставника 
            "Участник" -> /Форма для участник
